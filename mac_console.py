...
def status():
    ...
    try:
        ...
        progress = {}
    return {"running": running, "detail": "Mac 与 NAS 之间仅通过 SMB 读写。" if running else "可开始新的小批次任务。", "logs": logs, "progress": progress}
